...
$author            = get_post_meta( get_the_ID(), '_edd_featured_download_testimonial_author', true );
$author_image      = get_post_meta( get_the_ID(), '_edd_featured_download_testimonial_author_image', true );
            ...
            <div class=" flex flex-col lg:flex-row gap-y-4 items-center align-center lg:gap-x-18">
                <div class="rounded-full w-20 md:w-32 lg:w-48 shadow-md shrink-0 relative overflow-hidden">
                    <figure data-loading="lazy" class="relative aspect-1/1 !m-0">
                        <img alt="<?php echo strip_tags(
                             ...
                             width="400" height="400" src="<?php echo esc_html(
                                $author_image
                        ); ?>">
                    </figure>
                </div>
                <div class="!text-left">
                    <p class="inline-block relative z-10 text-xl lg:text-3xl font-brand !font-semibold">
                        <svg class="fill-current w-[1em] h-[1em] absolute -left-6 lg:-left-10 z-0 -top-6 lg:-top-10 h-auto text-primary-100 text-6xl lg:text-8xl"
                             viewBox="0 0 448 512">
