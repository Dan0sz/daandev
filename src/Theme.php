...
class Theme {
    ...
    public function primary_navigation() {
        ...
        <nav id="site-navigation"
             class="main-navigation header-navigation <?php echo $openType == 'click' ? 'click-to-open' : 'hover-to-open'; ?> nav--toggle-sub header-navigation-style-<?php echo esc_attr(
                        ...
                        <div class="drawer-nav-drop-wrap">
                            ...
                            <button class="drawer-sub-toggle" data-toggle-duration="10" data-toggle-target="#daan-dev-mobile-menu .menu-item-account-mobile-menu > .sub-menu" aria-expanded="false">
                                ...
                                <span class="kadence-svg-iconset">
                                    <svg aria-hidden="true" class="kadence-svg-icon kadence-arrow-down-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                         viewBox="0 0 24 24"><title>Expand</title><path
                                                d="M5.293 9.707l6 6c0.391 0.391 1.024 0.391 1.414 0l6-6c0.391-0.391 0.391-1.024 0-1.414s-1.024-0.391-1.414 0l-5.293 5.293-5.293-5.293c-0.391-0.391-1.024-0.391-1.414 0s-0.391 1.024 0 1.414z"></path></svg>
                                </span>
                            </button>
                        </div>
                        <?php if ( is_user_logged_in() ) : ?>
    ...
    /**
     * Add a check to @see edd_is_checkout()
     *
     * @param $value
     *
     * @return mixed|true
